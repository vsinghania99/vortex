...
private:
  ...
  uint16_t tc_size_;
  uint16_t tc_num_;
  uint16_t TC_per_core_;
  
public:
  Arch(uint16_t num_threads, uint16_t num_warps, uint16_t num_cores, uint64_t tc_size, uint64_t tc_num, uint64_t TC_per_core)   
